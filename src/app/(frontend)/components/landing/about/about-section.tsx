  ...
  return (
    <div className='grid lg:grid-cols-[2fr_1fr] px-5 py-10 lg:py-[80px] lg:px-[56px] lg:gap-30 gap-10'>
      ...
      <div>
       ...
       <div>
        <Image src={'https://res.cloudinary.com/dnu4lxiie/image/upload/v1764303559/about-image_bvebna.jpg'} alt='Logo' width={779} height={384.0441589355469} className='w-full h-full md:h-[384px] object-cover rounded-2xl' />
       </div>
